...
export default function AuthModal({ children }: AuthModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-md max-h-[60vh] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        <DialogHeader>
              ...
              <CardContent className="px-0">
                <form onSubmit={handleSignup} className="space-y-6">
                  ...
                  <div className="space-y-1">
                    <Label htmlFor="signup-universal">
                        Universal Access (Testing)
                      </Label>
                    <Input
                      id="signup-universal"
                      type="text"
                      placeholder="Enter access code for testing"
                      value={signupUniversalAccess}
                      onChange={(e) => setSignupUniversalAccess(e.target.value)}
                    />
                    <p className="text-xs text-muted-foreground flex items-center gap-1">
                      <Badge variant="secondary" className="text-xs">demo123</Badge>
                      Leave empty for normal signup
                    </p>
                  </div>
